...
urlpatterns = [
    ...
    path('maincategory/', MainCategoryList.as_view(), name='main-category'),
    path('Maincategory/<int:pk>', MainCategoryDetail.as_view(), name='main-category'),

    path('subcategory/', SubCategoryList.as_view(), name='main-category'),
    path('subcategory/<int:pk>', SubCategoryDetail.as_view(), name='main-category'),
